...
- Багшийн дэлгэцүүд хичээлээр саларсан. Ангийн сонголт нь багшийн заадаг хичээл тус бүрд нэг мөр, хоёроос дээш хичээл заадаг бол дээр нь «Бүх хичээл» мөр өгнө. Сонголт нь (анги, хичээл) хос болсон тул хуваарь, дэвтэр, үр дүн, хичээлийн жагсаалт бүгд түүнийг дагана.
- Харах ба засах эрх салсан. Хичээлийн багш зөвхөн өөрийн заадаг хичээлийг харж, засна. Ангийн багш нь `core.classes.class_teacher_id`-аар тэмдэглэгдэх бөгөөд тухайн ангийн **бүх** хичээлийг харна, харин **зөвхөн өөрөө заадаг** хичээлээ засна — хуваарь, дүн, үнэлгээ. Бага ангийн загвар яг энэ: ангийн багш математик, монгол хэл заана, англи хэлийг өөр багш заана; ангийн багш англи хэлийг хардаг ч үнэлж чадахгүй.
- Хуваарь нь ангийн багшид зөвхөн уншигдана: харагдана, товчнууд идэвхгүй, шалтгааныг бичсэн мөр гарна. `TeacherClass.canEdit` энэ ялгааг зөөнө.
- Хичээл заадаггүй бүртгэлд «Дэвтрийн үнэлгээ», «Шалгах ажлууд» цэс болон route хоёулаа нуугдана — 403 буцаадаг хуудас санал болгохын оронд. Session дээрх `takesLessons` талбар үүнийг хэлнэ.
- «Шалгах ажлууд» дэлгэцийг цэс, route хоёроос түр хассан. Тэр нь бичгэн хариултыг жагсаадаг ч өөрөө «зөвхөн харах горимд үнэлгээ хадгалахгүй» гэж бичсэн — багшийн оруулсан үнэлгээг хаядаг. Хуудас, endpoint нь кодод хэвээр; үнэлэх хэсгийг дуусгасны дараа буцаана.
- Багшийн «Сургалтын сан»-г «Хичээлийн материал» болгож нэрлэв. Ном өөрөө энд байдаггүй — тэр админы «Ном ба бүтэц» дээр; энэ нь хичээл, даалгавар, шалгах асуултууд.
- «Холболтууд» дэлгэц зөвхөн админд. Google холболт хийгдээгүй тул багшид үзүүлэх зүйлгүй.
- Багшийн «Хичээлийн материал» хичээлээр бүлэглэгдсэн. Сурагчийн «Хичээлийн сан»-г цэс, route-оос хассан — сургуулийн бүх хичээлийг сурагч сэглэх зориулалт нь өдрийн ажилтай нийцэхгүй. Хуудас, endpoint нь кодод хэвээр.
- Хичээлгүй `class_teachers` мөр одоо ямар ч эрх өгөхгүй. Өмнө нь "бүх хичээл заадаг" гэсэн утгатай байсан нь хэнийг ч зөв тодорхойлдоггүй байв.
- clearScheduleDay өдрийг бүхэлд нь устгадаг байсныг зассан. Математикийн харагдац дээр өдөр цэвэрлэхэд физик устдаг байв; одоо зөвхөн сонгосон хичээл арилна.
