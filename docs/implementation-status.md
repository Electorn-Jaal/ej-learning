...
- **Хуваалцсан ангид хичээл хоорондын хараа.** `authorisedClass` нь анги түвшинд шалгадаг тул нэг ангид математик заадаг багш тэр ангийн физикийн сорилын үр дүнг мөн харна. Хуваарь нь харин хичээлээр шүүгддэг (`subjectsTaughtBy`) — хоёр endpoint өөр дүрэмтэй байгаа нь зөрүү. Аль нь зөв бэ гэдгийг сургуультай тохирно: ангийн багш бүхнийг харах нь зөв байж мэднэ, хичээлийн багш зөвхөн өөрийнхөө хичээлийг харах нь ч зөв байж мэднэ. db:demo-гоор илэрсэн; жижиг fixture дээр харагдахгүй байсан.


- class_teachers одоо мөр бүрдээ өөрийн id-тай, давхардлыг (анги, багш, хичээл) дээрх UNIQUE NULLS NOT DISTINCT хаана. Нэг багш нэг ангид олон хичээл заахыг илэрхийлэх боломжтой боллоо. Migration 0012; бодит өгөгдөл дээр rollback дотор шалгасан.
- grade_levels нь 1–11, terms нь 1–3 хязгаартай. Сургуулийн бодит хэрэгцээтэй тулгана.
- native-learning дахь /preview/students ба /teacher/review-queue-г багшийн заадаг ангиар хязгаарласан. Өмнө нь role шалгадаг ч handler нь багшийн identity-г query-д дамжуулдаггүй байсан тул TEACHER эрхтэй бүртгэл сургуулийн бүх сурагчийн нэр, код, анги, мөн бүх ангийн бичгэн хариултыг уншиж чаддаг байсан. ADMIN нь урьдын адил бүгдийг харна. Тусгаарлалтыг integration тестээр хоёр багш, хоёр ангиар баталсан.
- rebuild-mastery одоо багшийн үнэлгээг устгахгүй. Өмнө нь бүх мөрийг устгаад зөвхөн quiz-ээс сэргээдэг байсан тул багшийн гараар өгсөн үнэлгээ бүрмөсөн алга болдог байв. Одоо TEACHER мөр хэвээр үлдэж, зөвхөн түүнээс хойшхи сорил дээр нь холилдоно. Тестээр баталсан.
