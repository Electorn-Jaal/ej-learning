  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          'group/day relative h-[var(--cell-size)] w-[var(--cell-size)] select-none p-0 text-center [&:first-child[data-selected=true]_button]:rounded-l-md [&:last-child[data-selected=true]_button]:rounded-r-md',
